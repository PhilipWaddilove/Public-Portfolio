...
As such, Transferwise records ~$5bn in monthly volumes and suggests it saves customers ~$1.5bn in fees per annum.  If the market for remittances generates ~$40bn annually, it has a market share of ~3.75%.  TransferWise appears to offer close to 'best-in-class' fees. x 
